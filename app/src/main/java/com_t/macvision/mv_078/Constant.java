package com_t.macvision.mv_078;/**
...
public class Constant {
    public static String BaseVideoListUrl = "http://192.168.1.124/demo/";
    public static String BaseVideoPlayUrl = "http://192.168.1.124/";
    public static String UploadUrl = "http://192.168.1.124/demo/upload/medias";
