...
//                    .into(image_thumb);
//            //显示图片来源标记
            Glide.with(mContext).load("http://192.168.1.124/default.jpg").override(ScreenUtils.getScreenWidth(mContext),ScreenUtils.getScreenHeight(mContext)/3).centerCrop().into(image_thumb);
