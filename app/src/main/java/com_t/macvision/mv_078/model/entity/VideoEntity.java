 ...
 */
public class VideoEntity extends SoulEntity implements Cloneable, Serializable {
    ...
    public List<VideolistEntity> getNewslist() {
        return data;
    }

    public void setNewslist(List<VideolistEntity> newslist) {
        this.data = newslist;
    }
